"""Minimum closed-loop competition demo.
...
and lands the fixed artifact bundle described in ROADMAP.md:

    runs/<timestamp>/
      ├── trace.jsonl          # end-to-end workflow trace
...
def run_comp1_demo(
    *,
    ...
    """Run the closed-loop demo and write the artifact bundle.
...
def _write_summary(
    ...
    lines.append("## 产物")
    lines.append("")
    lines.append("- `trace.jsonl` — 端到端轨迹")
